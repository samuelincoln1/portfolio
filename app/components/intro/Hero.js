...
export default function Hero() {
  return (
    <div className="container mx-auto md:mt-auto xl:mt-20 relative flex flex-col md:min-h-[calc(100vh-44px)] min-h-screen lg:flex-row gap-8 lg:gap-[106px] px-4 lg:px-0 items-center justify-center md:items-start md:justify-start">
