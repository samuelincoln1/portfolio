    ...
    <div className="flex flex-col lg:flex-row gap-8 lg:gap-[106px] items-center lg:items-start px-4 lg:px-0 ">
      <div className="flex flex-col gap-[40px]">
        <div className="flex flex-col gap-[1px]">
          <p className="text-[32px] md:text-[55px] font-bold text-center md:text-left">Olá, meu nome é Samuel e eu sou um</p>
          <p className="text-[32px] md:text-[55px] font-bold text-center md:text-left">Engenheiro Cloud</p>
        </div>

        <p className="text-[18px] max-w-[700px] text-center md:text-left">
        ...
        <p className="text-[18px] max-w-[600px] text-center md:text-left">
          Este portfólio está hospedado na AWS, utilizando o Amazon S3 para
          armazenamento e com distribuição global via CloudFront.
        </p>
        <Button className=" bg-[#77B2E9] text-white text-[24px] px-10 py-3 rounded-md hover:bg-[#5c9ee0] transition-colors self-center md:self-start">
