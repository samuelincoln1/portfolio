...
export default function Resume() {
  ...
  const languages = [
    {
      language: t("resume.languages.portuguese"),
      level: t("resume.languages.fluent"),
    },
    {
      language: t("resume.languages.english"),
      level: t("resume.languages.advanced"),
    },
  ];
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-black to-purple-950 py-16 relative">
        <div className="container mx-auto px-4 relative md:my-[135px] mt-8 z-10">
          ...
          <div className="flex flex-col gap-16">
                  ...
                  <ul className="space-y-4">
                    {technicalSkills
                      ...
                      .map((skill, index) => (
                        ...
                        >
                          <span className="w-2 h-2 bg-[#ffffff] rounded-full mr-3"></span>
                          {skill}
                        </li>
                      ))}
                  </ul>
              ...
              <div className="border border-white/20 shadow-lg backdrop-blur-[3px] p-8 rounded-lg">
                <div className="flex flex-row">
                  <div className="flex flex-col gap-6 text-[14px] md:text-[20px] text-white">
                    <p>{t("resume.coursesAndCertifications.description")}</p>

                    <p>{t("resume.coursesAndCertifications.description2")}</p>
                    <p>{t("resume.coursesAndCertifications.description3")}</p>
                  </div>
                </div>
              </div>
              <div className="flex flex-row items-center text-white md:text-2xl gap-4 mt-16">
                <a
            ...
            <div className="flex justify-center">
              <p className="text-sm text-white">{t("resume.copyright")}</p>
            </div>
          </div>
        </div>
      </div>
