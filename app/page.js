...
export default function Index() {
  return (
    <div>
      ...
      <div className="flex flex-col gap-8 bg-gradient-to-b from-black to-[#1a0329] py-6 md:py-13 px-4 md:px-0">
      ...
      <div className="md:px-30 px-6 relative flex flex-col bg-gradient-to-b from-[#1a0329] to-purple-950">
        <Projects />
